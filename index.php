...
class Updater {
	...
	public function checkForUpdate() {
		...
		if ($version !== '' && $version !== $this->currentVersion) {
			...
			$updateText = 'Migration to ' . htmlentities($versionString) . ' available. <br /><span class="light">Following file will be downloaded automatically:</span> <code class="light">' . $response['url'] . '</code>';
		} else {
			$updateText = 'Could not determine migration path to Nextcloud.';
		}
...
<div id="header">
	...
	<h1 class="header-appname">Migrate to Nextcloud</h1>
</div>
...
<div id="content-wrapper">
	<div id="content">
		...
		<div id="app-navigation">
			<ul>
				<li><a href="#progress">Migrate</a></li>
			</ul>
		</div>
		<div id="app-content">
